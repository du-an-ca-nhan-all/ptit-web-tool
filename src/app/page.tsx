...
export default function Home() {
  ...
  if (!state.isMounted) {
    return (
      <div className="flex h-full h-[100dvh] min-h-[100dvh] w-full bg-[#0F172A] items-center justify-center">
  ...
  return (
    <div className="flex h-full h-[100dvh] min-h-[100dvh] max-h-[100dvh] w-full bg-[#F1F5F9] font-sans text-slate-800 overflow-hidden relative">
      <Sidebar
