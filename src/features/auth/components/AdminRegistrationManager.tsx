      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 shrink-0">
          ...
          <div>
            <div
              className={`text-[11px] font-bold uppercase tracking-wider ${
                statusFilter === 'PENDING' ? 'text-amber-100' : 'text-slate-400'
              }`}
            >
              Chờ Duyệt
            </div>
        ...
        >
          <div>
            <div
              className={`text-[11px] font-bold uppercase tracking-wider ${
                statusFilter === 'APPROVED' ? 'text-emerald-100' : 'text-slate-400'
              }`}
            >
              Đã Duyệt
            </div>
            <div
              className={`text-2xl font-black ${
                statusFilter === 'APPROVED' ? 'text-white' : 'text-emerald-600'
              }`}
            >
              {counts.approved}
            </div>
        ...
        >
          <div>
            <div
              className={`text-[11px] font-bold uppercase tracking-wider ${
                statusFilter === 'REJECTED' ? 'text-rose-100' : 'text-slate-400'
              }`}
            >
              Đã Từ Chối
            </div>
            <div
              className={`text-2xl font-black ${
                statusFilter === 'REJECTED' ? 'text-white' : 'text-rose-600'
              }`}
            >
              {counts.rejected}
            </div>
          ...
          <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full overflow-hidden border border-slate-200 animate-in zoom-in-95 duration-200">
            ...
            <div className="p-6 flex flex-col gap-4">
              <div className="bg-slate-50 p-3 rounded-2xl border border-slate-200 text-xs">
                <div>
                  Sinh viên: <b>{rejectingItem.fullName || rejectingItem.username}</b>
                </div>
