...
import { CalendarDays, LogOut, LayoutDashboard, Calendar, Users, FileText, Search, Download, Wrench, ChevronDown, ChevronRight, GraduationCap, Mail, Settings, User, BookOpen } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div className="flex h-screen w-full bg-[#F1F5F9] font-sans text-slate-800 overflow-hidden">
      <aside className="w-64 bg-[#0F172A] flex flex-col shrink-0 hidden md:flex">
        ...
        <nav className="flex-1 px-4 space-y-2 mt-4">
          <div className="space-y-1">
            <button 
              onClick={() => setActiveTab('personal_schedule')}
            ...
            <button 
              onClick={() => setActiveTab('monitors_list')}
            ...
            {showCourseCompare && (
              <button 
                onClick={() => setActiveTab('course_compare')}
